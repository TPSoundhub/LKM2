# M2Salib.py
#
# M2Sa - Basic tonegeneration functions in mono  (one channel only)
# -----------------------------------------------------------------
# Programme that generates tones from sine waves - A basic version with limited amount of code lines for generating a sound
#
# Revision 0.4 - 01 Apr 2020 - Knud Funch, Soundhub Danmark - LYDKit til undervisningsbrug - Region MidtJylland
